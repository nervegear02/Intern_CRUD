...
import com.example.baptcserver.Adapter.MyCategoriesAdapter;
import com.example.baptcserver.Common.Common;
import com.example.baptcserver.Common.MySwipeHelper;
import com.example.baptcserver.Common.SpaceItemDecoration;
...
//        dialog.show();
    ...
    private void showDeleteDialog() {
        ...
        builder.setPositiveButton("DELETE", ((dialogInterface1, i1) -> deleteCategory()));
    ...
    private void showAddDialog() {
        ...
        builder.setPositiveButton("CREATE", (dialogInterface, i) -> {
            ...
            categoryModel.setCrops(new ArrayList<>());
